...
SCHEMA_ID = "G77_256DZ_RAW_EXECUTION_EVIDENCE_V1"
GENERATION_ID = "G77_256DZ_ONE_FRESH_BOUNDED_NON_PRODUCTION_E05_WRONG_CALLER_P11_GENERATION_V1"
ATTEMPT_ID = "G77_256DZ_E05_WRONG_CALLER_ATTEMPT_001"
AUTHORITY_REFERENCE = "G77_256DZ_WRONG_CALLER_NON_AUTHORITY_REFERENCE_001"
CASE_ID = "G77_256DZ_E05_WRONG_CALLER_DENIAL_BEFORE_ATTEMPT_001"
CHECKOUT = Path("/mnt/aigol")
RAW_ROOT = Path("/mnt/g77-evidence")
RAW_PATH = RAW_ROOT / "G77_256DZ_RAW_EXECUTION_EVIDENCE_V1.jsonl"
DZ_HARNESS_PATH = Path("/mnt/dp-harness/G77_256DZ_P11_OPERATIONAL_HARNESS_V1.py")
...
PRE_ACT_SEAL_PATH = RAW_ROOT / "G77_256DZ_PRE_ACT_CHECKPOINT_V1.json"
GUEST_SEAL_PATH = RAW_ROOT / "G77_256DZ_GUEST_EXECUTION_SEAL_V1.json"
TEARDOWN_SEAL_PATH = RAW_ROOT / "G77_256DZ_GUEST_TEARDOWN_SEAL_V1.json"
CONTINUATION_MANIFEST_PATH = RAW_ROOT / "G77_256DZ_CONTINUATION_MANIFEST_V1.json"
FIXTURE_ROOT = Path("/run/g77-256dz-p11")
...
def update_continuation_manifest(
    *,
    ...
    manifest.update({
        ...
        "frontier_state": {
            "constitutional_frontier": "ONE_AUTHORIZED_DZ_E05_WRONG_CALLER_GENERATION",
...
def create_wrong_caller_input(gate: Any, bindings: Any) -> tuple[bytes, dict[str, Any]]:
    ...
    contract_hash = replay_hash(
        {"contract": "G77_256DZ_E05_WRONG_CALLER_FAIL_CLOSED_V1"}
    )
    input_value = {
        ...
        "input_identity": "G77_256DZ_E05_WRONG_CALLER_INPUT_001",
        "provenance_identity": "G77_256DZ_AUTHENTICATED_CD_DY_MINIMUM_PROVENANCE_V1",
        "contract_identity": "G77_256DZ_E05_WRONG_CALLER_FAIL_CLOSED_CONTRACT_V1",
        ...
        "p10_inventory_identity": "G77_256DZ_P10_ONE_DENIAL_ZERO_RETRY_INVENTORY_V1",
        "comparator_outcome_identity": "G77_256DZ_E05_WRONG_CALLER_DENIAL_OUTCOME_001",
        "comparator_outcome": "FAILED_CLOSED",
        "replay_context_identity": "G77_256DZ_EXISTING_RUNTIMELEDGER_REPLAY_CONTEXT_V1",
    }
    ...
    try:
        ...
        if command == "INVOKE_WRONG_CALLER":
            ...
            request = CustodyRequest(
                ...
                request_identity="G77_256DZ_WRONG_CALLER_CUSTODY_REQUEST_001",
...
def main() -> int:
    if len(sys.argv) != 6:
        raise SystemExit("expected DZ_HARNESS_SHA SCHEMA_SHA HEAD TREE DN_HARNESS_SHA")
    ...
    try:
        actual_harness = sha256_path(DZ_HARNESS_PATH)
        ...
        evidence_id = append_record("commissioning_P03", "EVIDENCE", {
            ...
            "dn_instrument_scope": "CURRENT_DZ_ENVIRONMENT_PROSPECTIVE_ONLY",
        ...
        evidence_id = append_record("commissioning_P11", "HUMAN_DECISION", {
            "generation_authorization": "PRESENT__EXACT_DZ_WRONG_CALLER_CASE_ONLY",
        ...
        preact = {
            "schema_id": "G77_256DZ_PRE_ACT_CHECKPOINT_V1",
            "generation_identity": GENERATION_ID,
            ...
            "teardown_state": "PENDING",
            "checkpoint_is_authority": False,
            "continuation": "SAME_LIVE_DZ_GENERATION_ONLY__NO_REPLAY__NO_AUTHORITY_TRANSFER",
        }
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256DZ_PRE_ACT_CHECKPOINT_V1",
                "sha256": preact_sha,
            },),
        )
        ...
        guest_seal = {
            "schema_id": "G77_256DZ_GUEST_EXECUTION_SEAL_V1",
            "generation_identity": GENERATION_ID,
            "source_head": expected_head,
            "source_tree": expected_tree,
            "completed_gates": [
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256DZ_GUEST_EXECUTION_SEAL_V1",
        ...
        teardown_seal = {
            "schema_id": "G77_256DZ_GUEST_TEARDOWN_SEAL_V1",
            "generation_identity": GENERATION_ID,
        ...
        update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256DZ_GUEST_TEARDOWN_SEAL_V1",
