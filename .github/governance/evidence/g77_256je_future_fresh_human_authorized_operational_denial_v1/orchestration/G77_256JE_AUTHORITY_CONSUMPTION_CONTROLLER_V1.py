#!/usr/bin/env python3
"""Authenticate and consume the exact G77-256JE Human grant once.
...
PRESENTATION_PATH = JE / "G77_256JE_HUMAN_OPERATIONAL_AUTHORIZATION_PRESENTATION_V1.txt"
GRANT_PATH = JE / "G77_256JE_HUMAN_OPERATIONAL_AUTHORIZATION_SOURCE_V1.txt"
HANDOFF_PATH = JE / "G77_256JE_FRESH_HUMAN_OPERATIONAL_AUTHORIZATION_HANDOFF_V1.json"
SAFE_STOP_PATH = JE / "G77_256JE_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1.json"
CONSUMPTION_PATH = JE / "G77_256JE_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1.json"
...
MATERIALIZER_PATH = JE / "orchestration/G77_256JE_PREAUTHORIZATION_MATERIALIZER_V1.py"
...
ARGV_SHA256 = "92256e675832e3a43b39cf3bf7e3699d418707da2d22a0c0ff9d1a7d5a72afb3"
ANCHOR = "5c972e9960987ab27420395b54ace693df097e7b"

EXPECTED_NORMALIZED_GRANT = (
    "I explicitly authorize G77-256JE request " + REQUEST_SHA256
...
FM = load_module(FM_PATH, "g77_256je_authority_fm")
GN = load_module(GN_PATH, "g77_256je_authority_gn")
MATERIALIZER = load_module(MATERIALIZER_PATH, "g77_256je_authority_materializer")
...
def main(args: argparse.Namespace) -> None:
    ...
    if grant.replace("\\_", "_") != EXPECTED_NORMALIZED_GRANT:
        raise RuntimeError("Human grant does not exactly match the presented JE request")
    ...
    safe_stop = sealed(
        "G77_256JE_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256JE_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1",
            "recorded_at_utc": now(),
    ...
    consumption = sealed(
        "G77_256JE_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256JE_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1",
            "recorded_at_utc": now(),
            "generation_identity": GENERATION,
            "operation_identity": OPERATION,
