#!/usr/bin/env python3
"""Build the exact ER CONSUMED pre-materialization Canonical V1 candidate."""
...
REQUIRED_HEAD = "574b1c02f64df3c586ee4ad7214e2f677edf2dc3"
REQUIRED_TREE = "f6a66f07785ec3a825311a796f0e8e6fd1fc3408"
EI_PRODUCER_PATH = (
    ".github/governance/evidence/g77_256ei_producer_hardening_v1/"
    "producer/G77_256EI_EXACT_DU_PROHIBITION_PRODUCER_V1.py"
)
EVIDENCE_ROOT = ".github/governance/evidence/g77_256er_p11_operational_v1"
BUILDER_PATH = f"{EVIDENCE_ROOT}/builder/G77_256ER_CANONICAL_CANDIDATE_BUILDER_V1.py"
HARNESS_PATH = f"{EVIDENCE_ROOT}/harness/G77_256ER_P11_OPERATIONAL_HARNESS_V1.py"
RAW_SCHEMA_PATH = f"{EVIDENCE_ROOT}/G77_256ER_RAW_EVIDENCE_SCHEMA_V1.json"
META_DATA_PATH = f"{EVIDENCE_ROOT}/raw/G77_256ER_CLOUD_INIT_META_DATA_V1.yaml"
NETWORK_CONFIG_PATH = f"{EVIDENCE_ROOT}/raw/G77_256ER_CLOUD_INIT_NETWORK_CONFIG_V1.yaml"
USER_DATA_PATH = f"{EVIDENCE_ROOT}/raw/G77_256ER_CLOUD_INIT_USER_DATA_V1.yaml"
ATOMIC_CHECKPOINT_WRITER_PATH = (
    f"{EVIDENCE_ROOT}/checkpoint/"
    "G77_256ER_ATOMIC_CHECKPOINT_WRITER_V1.py"
)
QEMU_ARGV_BINDING_PATH = (
    f"{EVIDENCE_ROOT}/qemu_vector/G77_256ER_CANONICAL_QEMU_ARGV_V1.py"
)
QEMU_ARGV_CONTRACT_PATH = (
    f"{EVIDENCE_ROOT}/qemu_vector/G77_256ER_CANONICAL_QEMU_ARGV_CONTRACT_V1.md"
)
QEMU_ARGV_MATRIX_PATH = (
    f"{EVIDENCE_ROOT}/qemu_vector/G77_256ER_CANONICAL_QEMU_ARGV_VALIDATION_MATRIX_V1.json"
)
EB_FINAL_SEAL_PATH = (
...
LINEAGE = (
    ...
    (
        "G77_256EN_INTERRUPTED_CONSUMED_GENERATION_FINAL_EVIDENCE",
        ".github/governance/evidence/g77_256en_p11_operational_v1/"
        "G77_256EN_SPCE_FINAL_EXECUTION_SEAL_V1.json",
    ),
    (
        "G77_256EO_FAIL_CLOSED_EN_FINALIZATION_REPORT",
        "docs/governance/"
        "G77_256EO_CROSS_ACCOUNT_SPCE_RESUMPTION_AND_FAIL_CLOSED_COMPLETION_"
        "OF_INTERRUPTED_G77_256EN_V1.md",
    ),
    (
        "G77_256EQ_FAIL_CLOSED_EP_PREBOOT_BINDING_REPORT",
        "docs/governance/G77_256EQ_CROSS_ACCOUNT_SPCE_CONTINUATION_OF_INTERRUPTED_G77_256EP_V1.md",
    ),
    (
        "G77_256EQ_TERMINAL_PHASE_D_CHECKPOINT",
        ".github/governance/evidence/g77_256ep_p11_operational_v1/G77_256EP_SPCE_PHASE_D_FINAL_CHECKPOINT_V1.json",
    ),
    (
...
def build(repository_root: Path) -> dict[str, Any]:
    ...
    manifest.update({
        "generation_identity": (
            "G77_256ER_ONE_FRESH_BOUNDED_NON_PRODUCTION_E05_CONSUMED_REUSE_"
            "P11_GENERATION_V1"
        ),
        ...
        "extension_bindings": [
            extension(du, repository_root, "G77_256ER_CANDIDATE_BUILDER", BUILDER_PATH),
            extension(du, repository_root, "G77_256ER_P11_HARNESS", HARNESS_PATH),
            extension(du, repository_root, "G77_256ER_RAW_EVIDENCE_SCHEMA", RAW_SCHEMA_PATH),
            extension(du, repository_root, "G77_256ER_CLOUD_INIT_META_DATA", META_DATA_PATH),
            extension(du, repository_root, "G77_256ER_CLOUD_INIT_NETWORK_CONFIG", NETWORK_CONFIG_PATH),
            extension(du, repository_root, "G77_256ER_CLOUD_INIT_USER_DATA", USER_DATA_PATH),
            extension(
                du,
                repository_root,
                "G77_256ER_ATOMIC_CHECKPOINT_WRITER",
                ATOMIC_CHECKPOINT_WRITER_PATH,
            ),
            extension(
                du,
                repository_root,
                "G77_256ER_CANONICAL_QEMU_ARGV_BINDING",
                QEMU_ARGV_BINDING_PATH,
            ),
            extension(
                du,
                repository_root,
                "G77_256ER_CANONICAL_QEMU_ARGV_CONTRACT",
                QEMU_ARGV_CONTRACT_PATH,
            ),
            extension(
                du,
                repository_root,
                "G77_256ER_CANONICAL_QEMU_ARGV_VALIDATION_MATRIX",
                QEMU_ARGV_MATRIX_PATH,
            ),
