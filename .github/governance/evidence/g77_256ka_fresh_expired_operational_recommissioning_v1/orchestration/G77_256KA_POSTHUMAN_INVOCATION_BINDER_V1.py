#!/usr/bin/env python3
"""Bind a future KA Human handoff through the sole JZ-owned FM route.
...
argv to the committed JZ FM owner.  It starts no process and consumes no
authority.
"""
...
def load_fm() -> ModuleType:
    specification = importlib.util.spec_from_file_location("g77_256ka_jz_fm", FM_PATH)
