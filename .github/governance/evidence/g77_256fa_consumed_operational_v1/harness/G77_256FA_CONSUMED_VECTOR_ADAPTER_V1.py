#!/usr/bin/env python3
"""FA CONSUMED vector adapter over the hash-bound ER operational harness."""
...
ATTEMPT_ID = "G77_256FA_E05_CONSUMED_REUSE_ATTEMPT_001"
ACT_ID = "G77_256FA_EXACT_CURRENT_ONE_USE_HUMAN_OPERATIONAL_ACT_001"
CASE_ID = "G77_256FA_E05_CONSUMED_AUTHORITY_REUSE_DENIAL_001"
RAW_ROOT = Path("/mnt/g77-evidence")
CONTINUATION_MANIFEST_PATH = RAW_ROOT / "G77_256FA_CONTINUATION_MANIFEST_V1.json"
...
def configure(er: Any) -> None:
    ...
    er.RAW_PATH = RAW_ROOT / "G77_256FA_RAW_EXECUTION_EVIDENCE_V1.jsonl"
    er.PRE_ACT_SEAL_PATH = RAW_ROOT / "G77_256FA_PRE_ACT_CHECKPOINT_V1.json"
    er.AUTHORITY_SEAL_PATH = RAW_ROOT / "G77_256FA_AUTHORITY_CHECKPOINT_V1.json"
    er.GUEST_SEAL_PATH = RAW_ROOT / "G77_256FA_GUEST_EXECUTION_SEAL_V1.json"
    er.TEARDOWN_SEAL_PATH = RAW_ROOT / "G77_256FA_GUEST_TEARDOWN_SEAL_V1.json"
    er.CONTINUATION_MANIFEST_PATH = CONTINUATION_MANIFEST_PATH
    er.TERMINAL_CONTINUATION_MANIFEST_PATH = (
        RAW_ROOT / "G77_256FA_CONTINUATION_MANIFEST_TERMINAL_V1.json"
    )
    er.EN_HARNESS_PATH = (
        Path("/mnt/dp-harness") / "G77_256FA_CONSUMED_VECTOR_ADAPTER_V1.py"
    )
    er.FIXTURE_ROOT = Path("/run/g77-256fa-p11")
    ...
    def update_continuation_manifest(**kwargs: Any) -> tuple[str, dict[str, Any]]:
        ...
        manifest["frontier_state"]["constitutional_frontier"] = (
            "ONE_AUTHORIZED_FA_E05_CONSUMED_REUSE_GENERATION"
        )
