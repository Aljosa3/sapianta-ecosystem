#!/usr/bin/env python3
"""Build the one fresh FC WRONG_ATTEMPT candidate from certified producers."""
...
REQUIRED_HEAD = "f2626906b9a95631d921e6bb9a6947400c03a028"
REQUIRED_TREE = "977a5a5a43350dbe2270778a806dd20d6a31e87b"
GENERATION_ID = "G77_256FC_ONE_FRESH_HUMAN_AUTHORIZED_WRONG_ATTEMPT_OPERATIONAL_COMMISSIONING_V1"
ROOT = ".github/governance/evidence/g77_256fc_wrong_attempt_operational_v1"
...
EXTENSIONS = (
    ("G77_256FC_WRONG_ATTEMPT_VECTOR_ADAPTER", f"{ROOT}/harness/G77_256FC_WRONG_ATTEMPT_VECTOR_ADAPTER_V1.py"),
    ...
    ("G77_256FC_CLOUD_INIT_META_DATA", f"{ROOT}/raw/G77_256FC_CLOUD_INIT_META_DATA_V1.yaml"),
    ("G77_256FC_CLOUD_INIT_NETWORK_CONFIG", f"{ROOT}/raw/G77_256FC_CLOUD_INIT_NETWORK_CONFIG_V1.yaml"),
    ("G77_256FC_CLOUD_INIT_USER_DATA", f"{ROOT}/raw/G77_256FC_CLOUD_INIT_USER_DATA_V1.yaml"),
...
LINEAGE = (
    ...
    ("G77_256FA_FINAL_VALIDATION_SEAL", ".github/governance/evidence/g77_256fa_consumed_operational_v1/G77_256FA_FINAL_VALIDATION_SEAL_V1.json"),
...
def build(repository_root: Path) -> dict[str, Any]:
    ...
    manifest.update({
        ...
        "current_spce_phase": "PHASE_B_FC_WRONG_ATTEMPT_VECTOR_CANDIDATE",
        "phase_sequence": 1,
        ...
        "lineage_bindings": [du._lineage_binding(repository_root, identity, path) for identity, path in LINEAGE],
        "frontier_state": {
            "constitutional_frontier": "ONE_HUMAN_AUTHORIZED_FC_WRONG_ATTEMPT_E05_VECTOR",
            "exact_next_legal_action": "FRESH_DU_EB_EE_STATIC_ISOLATION_PREFLIGHT_BEFORE_ONE_MATERIALIZATION",
        ...
        "selected_case": {
            ...
            "obligation_id": "P11-E05/NEGATIVE_AUTHORITY/WRONG_ATTEMPT",
            "authorized_attempt_identity": "G77_256FC_E05_AUTHORIZED_ATTEMPT_001",
            "supplied_wrong_attempt_identity": "G77_256FC_E05_SUPPLIED_WRONG_ATTEMPT_002",
            "isolated_semantic_mutation_field": "attempt_identity",
        ...
        "observations": [
            "HUMAN_SELECTED_P11_E05_NEGATIVE_AUTHORITY_WRONG_ATTEMPT_ONLY",
            "EX_CERTIFIED_COMMON_SUBSTRATE_REFERENCED_NOT_RECONSTRUCTED",
            "FA_AND_EZ_ONE_SHOT_STATIC_BINDING_MECHANISMS_REUSED",
            "ONLY_ATTEMPT_IDENTITY_MAY_DIFFER_SEMANTICALLY",
