#!/usr/bin/env python3
"""Bound FUTURE to the existing FM/ER/FC/P11 route without operating it.

IZ statically supplies the executable guest contract that IF intentionally
omitted. Runtime use still requires a later committed target, fresh Human
authorization, and a separately governed one-shot operation.
"""
