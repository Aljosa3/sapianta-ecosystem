#!/usr/bin/env python3
"""Bind a future KC Human handoff through the sole JZ-owned FM route.

This module is inert in Phase A.  It accepts paths, never an authority digest,
and delegates construction and revalidation of the complete prospective FM
argv to the current FM owner.  It starts no process and consumes no authority.
"""
...
def load_fm() -> ModuleType:
    specification = importlib.util.spec_from_file_location("g77_256kc_jz_fm", FM_PATH)
