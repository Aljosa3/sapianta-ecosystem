#!/usr/bin/env python3
"""Authenticate and consume the exact G77-256IY Human grant once.
...
PRESENTATION_PATH = IY / "G77_256IY_HUMAN_OPERATIONAL_AUTHORIZATION_PRESENTATION_V1.txt"
GRANT_PATH = IY / "G77_256IY_HUMAN_OPERATIONAL_AUTHORIZATION_SOURCE_V1.txt"
HANDOFF_PATH = IY / "G77_256IY_FRESH_HUMAN_OPERATIONAL_AUTHORIZATION_HANDOFF_V1.json"
SAFE_STOP_PATH = IY / "G77_256IY_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1.json"
CONSUMPTION_PATH = IY / "G77_256IY_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1.json"
...
REQUEST_SHA256 = "34ff5f440aed0d2add6dbf194fa160eaa44dafef5a75defc634c3af131dcc4b2"
...
ARGV_SHA256 = "439ebb23c145717cae77f121067a5ecbc94923b44747e271addd11222ef32e07"
ANCHOR = "5c972e9960987ab27420395b54ace693df097e7b"

EXPECTED_NORMALIZED_GRANT = (
    "I explicitly authorize G77-256IY request " + REQUEST_SHA256
...
FM = load_module(FM_PATH, "g77_256iy_authority_fm")
GN = load_module(GN_PATH, "g77_256iy_authority_gn")
MATERIALIZER = load_module(MATERIALIZER_PATH, "g77_256iy_authority_materializer")
...
def main(args: argparse.Namespace) -> None:
    ...
    if grant.replace("\\_", "_") != EXPECTED_NORMALIZED_GRANT:
        raise RuntimeError("Human grant does not exactly match the presented IY request")
    ...
    safe_stop = sealed(
        "G77_256IY_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256IY_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1",
            "recorded_at_utc": now(),
    ...
    consumption = sealed(
        "G77_256IY_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256IY_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1",
            "recorded_at_utc": now(),
            "generation_identity": GENERATION,
            "operation_identity": OPERATION,
