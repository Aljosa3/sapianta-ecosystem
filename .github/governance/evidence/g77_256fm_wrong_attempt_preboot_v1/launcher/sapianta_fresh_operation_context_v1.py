...
WRONG_PROVENANCE_ADAPTER_SOURCE_RELATIVE_PATH = (
...
EXPIRED_ADAPTER_SOURCE_RELATIVE_PATH = (
...
WRONG_SCOPE_ADAPTER_SOURCE_RELATIVE_PATH = (
    ".github/governance/evidence/"
...
WRONG_PROVENANCE_ADAPTER_IDENTITY_SUFFIX = "_WRONG_PROVENANCE_VECTOR_ADAPTER_V1.py"
FUTURE_ADAPTER_IDENTITY_SUFFIX = "_FUTURE_VECTOR_ADAPTER_V1.py"
EXPIRED_ADAPTER_IDENTITY_SUFFIX = "_EXPIRED_VECTOR_ADAPTER_V1.py"
WRONG_SCOPE_ADAPTER_IDENTITY_SUFFIX = "_WRONG_SCOPE_VECTOR_ADAPTER_V1.py"
...
def operation_vector(generation_identity: str) -> str:
    ...
    suffixes = {
        ...
        "_ONE_FRESH_HUMAN_AUTHORIZED_WRONG_PROVENANCE_OPERATIONAL_COMMISSIONING_V1": WRONG_PROVENANCE,
        "_ONE_FRESH_HUMAN_AUTHORIZED_FUTURE_OPERATIONAL_COMMISSIONING_V1": FUTURE,
        "_ONE_FRESH_HUMAN_AUTHORIZED_EXPIRED_OPERATIONAL_COMMISSIONING_V1": EXPIRED,
        "_ONE_FRESH_HUMAN_AUTHORIZED_WRONG_SCOPE_OPERATIONAL_COMMISSIONING_V1": WRONG_SCOPE,
    }
...
def adapter_source_relative_path(generation_identity: str) -> str:
    paths = {
        ...
        WRONG_PROVENANCE: WRONG_PROVENANCE_ADAPTER_SOURCE_RELATIVE_PATH,
        FUTURE: FUTURE_ADAPTER_SOURCE_RELATIVE_PATH,
        EXPIRED: EXPIRED_ADAPTER_SOURCE_RELATIVE_PATH,
        WRONG_SCOPE: WRONG_SCOPE_ADAPTER_SOURCE_RELATIVE_PATH,
    }
...
def derive_guest_adapter_binding(
    ...
    *,
    ...
    suffixes = {
        ...
        WRONG_PROVENANCE: WRONG_PROVENANCE_ADAPTER_IDENTITY_SUFFIX,
        FUTURE: FUTURE_ADAPTER_IDENTITY_SUFFIX,
        EXPIRED: EXPIRED_ADAPTER_IDENTITY_SUFFIX,
        WRONG_SCOPE: WRONG_SCOPE_ADAPTER_IDENTITY_SUFFIX,
    }
