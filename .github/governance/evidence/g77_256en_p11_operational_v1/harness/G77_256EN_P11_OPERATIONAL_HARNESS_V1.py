...
SCHEMA_ID = "G77_256EN_RAW_EXECUTION_EVIDENCE_V1"
GENERATION_ID = "G77_256EN_ONE_FRESH_BOUNDED_NON_PRODUCTION_E05_CONSUMED_REUSE_P11_GENERATION_V1"
ATTEMPT_ID = "G77_256EN_E05_CONSUMED_REUSE_ATTEMPT_001"
ACT_ID = "G77_256EN_EXACT_CURRENT_ONE_USE_HUMAN_OPERATIONAL_ACT_001"
CASE_ID = "G77_256EN_E05_CONSUMED_AUTHORITY_REUSE_DENIAL_001"
CHECKOUT = Path("/mnt/aigol")
RAW_ROOT = Path("/mnt/g77-evidence")
RAW_PATH = RAW_ROOT / "G77_256EN_RAW_EXECUTION_EVIDENCE_V1.jsonl"
EN_HARNESS_PATH = Path("/mnt/dp-harness/G77_256EN_P11_OPERATIONAL_HARNESS_V1.py")
...
PRE_ACT_SEAL_PATH = RAW_ROOT / "G77_256EN_PRE_ACT_CHECKPOINT_V1.json"
AUTHORITY_SEAL_PATH = RAW_ROOT / "G77_256EN_AUTHORITY_CHECKPOINT_V1.json"
GUEST_SEAL_PATH = RAW_ROOT / "G77_256EN_GUEST_EXECUTION_SEAL_V1.json"
TEARDOWN_SEAL_PATH = RAW_ROOT / "G77_256EN_GUEST_TEARDOWN_SEAL_V1.json"
CONTINUATION_MANIFEST_PATH = RAW_ROOT / "G77_256EN_CONTINUATION_MANIFEST_V1.json"
TERMINAL_CONTINUATION_MANIFEST_PATH = RAW_ROOT / "G77_256EN_CONTINUATION_MANIFEST_TERMINAL_V1.json"
...
def create_input_and_authority(gate: Any, bindings: Any, store: Any) -> tuple[Any, ...]:
    ...
    contract_hash = replay_hash({"contract": "G77_256EN_E05_CONSUMED_REUSE_FAIL_CLOSED_AUTHORITY_V1"})
    input_value = {
        ...
        "input_identity": "G77_256EN_E05_CONSUMED_REUSE_INPUT_001",
        "provenance_identity": "G77_256EN_AUTHENTICATED_EM_CD_MINIMUM_PROVENANCE_V1",
        "contract_identity": "G77_256EN_E05_CONSUMED_REUSE_FAIL_CLOSED_AUTHORITY_CONTRACT_V1",
        ...
        "p10_inventory_identity": "G77_256EN_P10_ONE_ATTEMPT_ZERO_RETRY_INVENTORY_V1",
        "comparator_outcome_identity": "G77_256EN_E05_FIRST_AUTHORIZED_EQUAL_OUTCOME_001",
        "comparator_outcome": "EQUAL",
        "replay_context_identity": "G77_256EN_EXISTING_RUNTIMELEDGER_REPLAY_CONTEXT_V1",
    }
    ...
    payload = {
        ...
        "case_id": CASE_ID,
        "evidence_run_identity": "G77_256EN_CONSUMED_REUSE_EVIDENCE_RUN_001",
    ...
    act = CanonicalHumanAuthorityActV1(
        ...
        interaction_identity="G77_256EN_INTERACTION_001",
        conversation_identity="G77_256EN_CONVERSATION_001",
        session_identity="G77_256EN_SESSION_001",
        actor_identity="HUMAN_CONSTITUTIONAL_AUTHORITY",
        request_identity="G77_256EN_REQUEST_001",
        continuation_identity="G77_256EN_CONTINUATION_001",
        ...
        metadata={
            ...
            "human_authorization_source": "G77_256EN_CURRENT_PROMPT",
    ...
    correlation = create_canonical_che_evidence_correlation_v1(
        ...
        source_channel_identity="G77_256EN_HUMAN_AUTHORIZATION_CHANNEL",
        adapter_identity="G77_256EN_CANONICAL_BINDING_ADAPTER",
        request_identity=act.request_identity,
        che_entry_identity="G77_256EN_CHE_ENTRY_001",
        source_act_identity=act.authority_act_identity,
        source_act_digest=replay_hash(act.to_dict()),
        order_identity="G77_256EN_ORDER_001",
        idempotency_identity="G77_256EN_IDEMPOTENCY_001",
        ...
        authority_result_identity="G77_256EN_AUTHORITY_RESULT_001",
        ...
        owner_projection_identity="G77_256EN_OWNER_PROJECTION_001",
        failure_identity=NOT_APPLICABLE,
        presentation_identity="G77_256EN_PRESENTATION_001",
        response_identity="G77_256EN_RESPONSE_001",
        response_digest=replay_hash({"response": "G77_256EN_AUTHORITY_RECORDED"}),
        delivery_record_identity="G77_256EN_DELIVERY_001",
...
def custody_process(
    ...
    try:
        ...
        request = CustodyRequest(
            ...
            request_identity="G77_256EN_CUSTODY_REQUEST_001",
        ...
        reuse_request = CustodyRequest(
            protocol_identity="P11_DA_DISPOSABLE_LOCAL_IPC_V1",
            operation=CustodyOperation.CLAIM_AND_INVOKE_ONCE,
            request_identity="G77_256EN_CUSTODY_REQUEST_CONSUMED_REUSE_002",
            canonical_payload=input_bytes,
        )
...
def main() -> int:
    ...
    try:
        ...
        preact = {
            "schema_id": "G77_256EN_PRE_ACT_CHECKPOINT_V1",
            "generation_identity": GENERATION_ID,
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EN_PRE_ACT_CHECKPOINT_V1",
                "sha256": preact_sha,
            },),
        )
        ...
        authority_seal = {
            "schema_id": "G77_256EN_AUTHORITY_CHECKPOINT_V1",
            "generation_identity": GENERATION_ID,
            "attempt_identity": ATTEMPT_ID,
            "authority_act_identity": ACT_ID,
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EN_AUTHORITY_CHECKPOINT_V1",
        ...
        guest_seal = {
            "schema_id": "G77_256EN_GUEST_EXECUTION_SEAL_V1",
            "generation_identity": GENERATION_ID,
            "source_head": expected_head,
            "source_tree": expected_tree,
            "completed_gates": [
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EN_GUEST_EXECUTION_SEAL_V1",
        ...
        teardown_seal = {
            "schema_id": "G77_256EN_GUEST_TEARDOWN_SEAL_V1",
            "generation_identity": GENERATION_ID,
        ...
        update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EN_GUEST_TEARDOWN_SEAL_V1",
