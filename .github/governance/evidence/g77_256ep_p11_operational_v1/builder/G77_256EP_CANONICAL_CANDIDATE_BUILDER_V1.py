#!/usr/bin/env python3
"""Build the exact EP CONSUMED pre-materialization Canonical V1 candidate."""
...
REQUIRED_HEAD = "5306f88ca1cc22e7681a7f042481a69c0a8396cf"
REQUIRED_TREE = "61b86737812c528ce68d70ebd52b5372e3c3b193"
EI_PRODUCER_PATH = (
    ".github/governance/evidence/g77_256ei_producer_hardening_v1/"
    "producer/G77_256EI_EXACT_DU_PROHIBITION_PRODUCER_V1.py"
)
EVIDENCE_ROOT = ".github/governance/evidence/g77_256ep_p11_operational_v1"
BUILDER_PATH = f"{EVIDENCE_ROOT}/builder/G77_256EP_CANONICAL_CANDIDATE_BUILDER_V1.py"
HARNESS_PATH = f"{EVIDENCE_ROOT}/harness/G77_256EP_P11_OPERATIONAL_HARNESS_V1.py"
RAW_SCHEMA_PATH = f"{EVIDENCE_ROOT}/G77_256EP_RAW_EVIDENCE_SCHEMA_V1.json"
META_DATA_PATH = f"{EVIDENCE_ROOT}/raw/G77_256EP_CLOUD_INIT_META_DATA_V1.yaml"
NETWORK_CONFIG_PATH = f"{EVIDENCE_ROOT}/raw/G77_256EP_CLOUD_INIT_NETWORK_CONFIG_V1.yaml"
USER_DATA_PATH = f"{EVIDENCE_ROOT}/raw/G77_256EP_CLOUD_INIT_USER_DATA_V1.yaml"
ATOMIC_CHECKPOINT_WRITER_PATH = (
    f"{EVIDENCE_ROOT}/checkpoint/"
    "G77_256EP_ATOMIC_CHECKPOINT_WRITER_V1.py"
)
EB_FINAL_SEAL_PATH = (
...
def build(repository_root: Path) -> dict[str, Any]:
    ...
    manifest.update({
        "generation_identity": (
            "G77_256EP_ONE_FRESH_BOUNDED_NON_PRODUCTION_E05_CONSUMED_REUSE_"
            "P11_GENERATION_V1"
        ),
        ...
        "extension_bindings": [
            extension(du, repository_root, "G77_256EP_CANDIDATE_BUILDER", BUILDER_PATH),
            extension(du, repository_root, "G77_256EP_P11_HARNESS", HARNESS_PATH),
            extension(du, repository_root, "G77_256EP_RAW_EVIDENCE_SCHEMA", RAW_SCHEMA_PATH),
            extension(du, repository_root, "G77_256EP_CLOUD_INIT_META_DATA", META_DATA_PATH),
            extension(du, repository_root, "G77_256EP_CLOUD_INIT_NETWORK_CONFIG", NETWORK_CONFIG_PATH),
            extension(du, repository_root, "G77_256EP_CLOUD_INIT_USER_DATA", USER_DATA_PATH),
            extension(
                du,
                repository_root,
                "G77_256EP_ATOMIC_CHECKPOINT_WRITER",
                ATOMIC_CHECKPOINT_WRITER_PATH,
            ),
