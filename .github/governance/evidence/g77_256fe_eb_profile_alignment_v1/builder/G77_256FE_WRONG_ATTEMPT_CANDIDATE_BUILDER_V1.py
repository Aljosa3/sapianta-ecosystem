#!/usr/bin/env python3
"""Build the sole FE canonical-profile WRONG_ATTEMPT preflight candidate."""
...
GENERATION_ID = "G77_256FE_REPOSITORY_ONLY_EB_CANONICAL_VALIDATION_PROFILE_ALIGNMENT_AND_DU_EB_EE_PREFLIGHT_V1"
ROOT = ".github/governance/evidence/g77_256fe_eb_profile_alignment_v1"
...
LINEAGE = (
    ...
    ("G77_256FD_FAIL_CLOSED_FINAL_SEAL", ".github/governance/evidence/g77_256fd_wrong_attempt_schema_alignment_v1/G77_256FD_FINAL_VALIDATION_SEAL_V1.json"),
    ("G77_256FD_G48_REPORT", "docs/governance/G77_256FD_CROSS_ACCOUNT_WRONG_ATTEMPT_SCHEMA_ALIGNMENT_AND_FAIL_CLOSED_EB_PREFLIGHT_V1.md"),
    ("G48_REPORTING_STANDARD", "docs/governance/G48_00_CONSTITUTIONAL_EVIDENCE_REPORTING_STANDARD_V1.md"),
)

EXTENSIONS = (
    ("G77_256FE_PHASE_A_CHECKPOINT", f"{ROOT}/G77_256FE_SPCE_PHASE_A_CHECKPOINT_V1.json"),
    ("G77_256FE_CANONICAL_EB_PROFILE_CALLER", f"{ROOT}/orchestration/G77_256FE_CANONICAL_EB_PROFILE_CALLER_V1.py"),
    ("G77_256FE_WRONG_ATTEMPT_PREFLIGHT_ADAPTER", f"{ROOT}/binding/G77_256FE_WRONG_ATTEMPT_PREFLIGHT_ADAPTER_V1.py"),
    ("G77_256FD_WRONG_ATTEMPT_VECTOR_EVIDENCE", ".github/governance/evidence/g77_256fd_wrong_attempt_schema_alignment_v1/binding/G77_256FD_WRONG_ATTEMPT_VECTOR_EVIDENCE_V1.json"),
...
def build(repository_root: Path) -> dict[str, Any]:
    ...
    manifest.update({
        ...
        "current_spce_phase": "PHASE_B_FE_CANONICAL_EB_PROFILE_WRONG_ATTEMPT_REPOSITORY_PREFLIGHT_CANDIDATE",
        "phase_sequence": 1,
        ...
        "frontier_state": {
            "constitutional_frontier": "FE_CANONICAL_EB_PROFILE_ALIGNMENT_FOR_DU_ADMITTED_WRONG_ATTEMPT_PATTERN",
            "exact_next_legal_action": "RUN_DU_ONCE_THEN_CANONICAL_PROFILE_EB_ONCE_THEN_EE_ONCE_IF_EACH_PRECEDING_GATE_PASSES__STOP",
        ...
        "first_failure_or_current_result": "PENDING__DU_CANONICAL_EB_PROFILE_AND_EE_REPOSITORY_PREFLIGHT_REQUIRED",
        ...
        "observations": [
            "HUMAN_AUTHORIZED_G77_256FE_REPOSITORY_ONLY_EB_PROFILE_ALIGNMENT",
            "P11_E05_NEGATIVE_AUTHORITY_WRONG_ATTEMPT_VECTOR_ONLY",
            "FD_DU_ADMITTED_TWO_FIELD_SELECTED_CASE_REPRESENTATION_REUSED",
            "FD_VECTOR_EVIDENCE_SEMANTICS_REUSED_WITHOUT_RECONSTRUCTION",
            "EB_CANONICAL_PROFILE_CANONICAL_V1_PRE_MATERIALIZATION_FOUR_GATE_CANDIDATE_BOUND_V1",
            "EB_PROFILE_SELECTION_IS_CALLER_ORCHESTRATION_NOT_CANDIDATE_CONTENT",
...
def main() -> int:
    ...
    if output.exists() or runtime_output.exists():
        raise RuntimeError("FE candidate or runtime projection already exists")
    ei = load_ei(repository_root)
    du = ei.load_du(repository_root)
