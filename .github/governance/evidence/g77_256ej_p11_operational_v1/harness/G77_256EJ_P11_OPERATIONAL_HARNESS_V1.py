#!/usr/bin/env python3
"""One fresh bounded EJ WRONG_CALLER attempt with durable raw evidence."""
...
SCHEMA_ID = "G77_256EJ_RAW_EXECUTION_EVIDENCE_V1"
GENERATION_ID = "G77_256EJ_ONE_FRESH_BOUNDED_NON_PRODUCTION_E05_WRONG_CALLER_P11_GENERATION_V1"
ATTEMPT_ID = "G77_256EJ_E05_WRONG_CALLER_ATTEMPT_001"
AUTHORITY_REFERENCE = "G77_256EJ_WRONG_CALLER_NON_AUTHORITY_REFERENCE_001"
CASE_ID = "G77_256EJ_E05_WRONG_CALLER_DENIAL_BEFORE_ATTEMPT_001"
CHECKOUT = Path("/mnt/aigol")
RAW_ROOT = Path("/mnt/g77-evidence")
RAW_PATH = RAW_ROOT / "G77_256EJ_RAW_EXECUTION_EVIDENCE_V1.jsonl"
EJ_HARNESS_PATH = Path("/mnt/dp-harness/G77_256EJ_P11_OPERATIONAL_HARNESS_V1.py")
...
PRE_ACT_SEAL_PATH = RAW_ROOT / "G77_256EJ_PRE_ACT_CHECKPOINT_V1.json"
GUEST_SEAL_PATH = RAW_ROOT / "G77_256EJ_GUEST_EXECUTION_SEAL_V1.json"
TEARDOWN_SEAL_PATH = RAW_ROOT / "G77_256EJ_GUEST_TEARDOWN_SEAL_V1.json"
CONTINUATION_MANIFEST_PATH = RAW_ROOT / "G77_256EJ_CONTINUATION_MANIFEST_V1.json"
TERMINAL_CONTINUATION_MANIFEST_PATH = (
    RAW_ROOT / "G77_256EJ_CONTINUATION_MANIFEST_TERMINAL_V1.json"
)
FIXTURE_ROOT = Path("/run/g77-256ej-p11")
...
def create_wrong_caller_input(gate: Any, bindings: Any) -> tuple[bytes, dict[str, Any]]:
    ...
    contract_hash = replay_hash(
        {"contract": "G77_256EJ_E05_WRONG_CALLER_FAIL_CLOSED_V1"}
    )
    input_value = {
        ...
        "input_identity": "G77_256EJ_E05_WRONG_CALLER_INPUT_001",
        "provenance_identity": "G77_256EJ_AUTHENTICATED_CD_DY_MINIMUM_PROVENANCE_V1",
        "contract_identity": "G77_256EJ_E05_WRONG_CALLER_FAIL_CLOSED_CONTRACT_V1",
        ...
        "p10_inventory_identity": "G77_256EJ_P10_ONE_DENIAL_ZERO_RETRY_INVENTORY_V1",
        "comparator_outcome_identity": "G77_256EJ_E05_WRONG_CALLER_DENIAL_OUTCOME_001",
        "comparator_outcome": "FAILED_CLOSED",
        "replay_context_identity": "G77_256EJ_EXISTING_RUNTIMELEDGER_REPLAY_CONTEXT_V1",
    }
...
def main() -> int:
    ...
    if any(path.exists() for path in expected_absent):
        raise SystemExit("EJ evidence sink is not empty")
    if not CONTINUATION_MANIFEST_PATH.is_file():
        raise SystemExit("EJ continuation manifest is absent")
    ...
    try:
        actual_harness = sha256_path(EJ_HARNESS_PATH)
        if actual_harness != expected_harness:
            raise RuntimeError("EJ harness hash mismatch")
        ...
        preact = {
            "schema_id": "G77_256EJ_PRE_ACT_CHECKPOINT_V1",
            "generation_identity": GENERATION_ID,
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EJ_PRE_ACT_CHECKPOINT_V1",
                "sha256": preact_sha,
            },),
        )
        ...
        guest_seal = {
            "schema_id": "G77_256EJ_GUEST_EXECUTION_SEAL_V1",
            "generation_identity": GENERATION_ID,
            "source_head": expected_head,
            "source_tree": expected_tree,
            "completed_gates": [
        ...
        manifest_file_sha, manifest_envelope = update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EJ_GUEST_EXECUTION_SEAL_V1",
        ...
        teardown_seal = {
            "schema_id": "G77_256EJ_GUEST_TEARDOWN_SEAL_V1",
            "generation_identity": GENERATION_ID,
        ...
        update_continuation_manifest(
            ...
            additional_completed_seals=({
                "identity": "G77_256EJ_GUEST_TEARDOWN_SEAL_V1",
