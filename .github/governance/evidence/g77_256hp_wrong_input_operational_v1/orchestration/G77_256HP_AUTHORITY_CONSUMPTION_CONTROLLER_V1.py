#!/usr/bin/env python3
"""Authenticate and consume the exact G77-256HP Human grant once.
...
CANDIDATE_PATH = LIVE / "candidate/G77_256GY_WRONG_INPUT_POST_COMMIT_CANDIDATE_V1.json"
...
GRANT_PATH = HP / "G77_256HP_HUMAN_OPERATIONAL_AUTHORIZATION_SOURCE_V1.txt"
HANDOFF_PATH = HP / "G77_256HP_FRESH_HUMAN_OPERATIONAL_AUTHORIZATION_HANDOFF_V1.json"
SAFE_STOP_PATH = HP / "G77_256HP_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1.json"
CONSUMPTION_PATH = HP / "G77_256HP_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1.json"
...
REQUEST_SHA256 = "d4e8b870eae51dcfb69c0594531baab3da1a4287b96a7d66034c6f4d589fab87"
CANDIDATE_SHA256 = "fedf8eaf876623e57ceb87231327512ee22ea54503fe3eb5d28747c0bfd56aba"
CONTEXT_SHA256 = "4d8ec70c40f08cd334ef3070495c524a7e20d2ba92c5f0be530ff397b773ea72"
ARGV_SHA256 = "32b1bcbc80035e5f12ff5b73c83d44baeebf68cb7e9e515ae32fb47fd05178d5"
ANCHOR = "5c972e9960987ab27420395b54ace693df097e7b"

EXPECTED_NORMALIZED_GRANT = (
    "I explicitly authorize G77-256HP request " + REQUEST_SHA256
    + " for operation " + OPERATION
    + ", candidate " + CANDIDATE_SHA256
    + ", context " + CONTEXT_SHA256
    + ", and canonical argv " + ARGV_SHA256
    + ", starting from E05 7/18, subject to exactly one authority consumption, "
...
FM = load_module(FM_PATH, "g77_256hp_authority_fm")
GN = load_module(GN_PATH, "g77_256hp_authority_gn")
...
def zero_counters(human_authority: int, consumption: int) -> dict[str, int]:
    return {
...
def main(args: argparse.Namespace) -> None:
    ...
    if grant.replace("\\_", "_") != EXPECTED_NORMALIZED_GRANT:
        raise RuntimeError("Human grant does not exactly match the presented HP request")
    ...
    safe_stop = sealed(
        "G77_256HP_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256HP_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1",
            "recorded_at_utc": now(),
            ...
            "operational_counters": zero_counters(1, 0),
            "e05": "7/18",
            "auto_continuable": False,
    ...
    observed_assets = FM.observe_context_assets(
        ROOT, context, CANDIDATE_PATH.relative_to(ROOT)
    )
    ...
    consumption = sealed(
        "G77_256HP_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256HP_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1",
            "recorded_at_utc": now(),
            "generation_identity": GENERATION,
            "operation_identity": OPERATION,
            ...
            "operational_counters": zero_counters(1, 1),
            "e05": "7/18",
            "auto_continuable": False,
            "human_review_required": True,
        },
