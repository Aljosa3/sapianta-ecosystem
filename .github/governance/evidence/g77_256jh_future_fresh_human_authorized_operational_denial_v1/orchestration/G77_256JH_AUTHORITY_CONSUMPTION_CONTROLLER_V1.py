#!/usr/bin/env python3
"""Authenticate and consume the exact G77-256JH Human grant once.
...
GRANT_PATH = JH / "G77_256JH_HUMAN_OPERATIONAL_AUTHORIZATION_SOURCE_V1.txt"
HANDOFF_PATH = JH / "G77_256JH_FRESH_HUMAN_OPERATIONAL_AUTHORIZATION_HANDOFF_V1.json"
SAFE_STOP_PATH = JH / "G77_256JH_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1.json"
CONSUMPTION_PATH = JH / "G77_256JH_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1.json"
...
MATERIALIZER_PATH = JH / "orchestration/G77_256JH_PREAUTHORIZATION_MATERIALIZER_V1.py"
...
REQUEST_SHA256 = "e419e62e152c2f86db15f612be9452fa2939323f41cf82bad8247c90f1625b53"
CANDIDATE_SHA256 = "ad5d204ec6ace09f18b83fd5f868e73dac5e36dad81149f9f335c87f68cf42f7"
CONTEXT_SHA256 = "1c91aed9619818ae712bffebeda82153c5b8e52e0197b55c18d3befa1323a275"
ARGV_SHA256 = "2087f3b37a739d122cf7d06087bb5127d7911ba62247f355ecfd17ce9b02e949"
ANCHOR = "5c972e9960987ab27420395b54ace693df097e7b"

EXPECTED_NORMALIZED_GRANT = (
    "I explicitly authorize G77-256JH request " + REQUEST_SHA256
...
FM = load_module(FM_PATH, "g77_256jh_authority_fm")
GN = load_module(GN_PATH, "g77_256jh_authority_gn")
MATERIALIZER = load_module(MATERIALIZER_PATH, "g77_256jh_authority_materializer")
...
def main(args: argparse.Namespace) -> None:
    ...
    if grant.replace("\\_", "_") != EXPECTED_NORMALIZED_GRANT:
        raise RuntimeError("Human grant does not exactly match the presented JH request")
    ...
    safe_stop = sealed(
        "G77_256JH_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256JH_POSTGRANT_PRECONSUMPTION_SAFE_STOP_CHECKPOINT_V1",
            "recorded_at_utc": now(),
    ...
    consumption = sealed(
        "G77_256JH_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_ENVELOPE_V1",
        "checkpoint",
        {
            "schema_id": "G77_256JH_AUTHORITY_VALIDATION_AND_CONSUMPTION_CHECKPOINT_V1",
            "recorded_at_utc": now(),
            "generation_identity": GENERATION,
            "operation_identity": OPERATION,
