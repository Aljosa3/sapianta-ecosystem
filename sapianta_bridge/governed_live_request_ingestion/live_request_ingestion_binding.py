"""Live request ingestion continuity binding."""
...
class LiveRequestIngestionBinding:
...
def create_live_request_ingestion_binding(*, ingestion_session: dict, gateway_output: dict) -> LiveRequestIngestionBinding:
    binding = gateway_output["serving_gateway_binding"]
    return LiveRequestIngestionBinding(
