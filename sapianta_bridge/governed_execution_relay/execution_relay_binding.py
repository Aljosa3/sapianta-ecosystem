"""Governed execution relay continuity binding."""
...
def create_execution_relay_binding(*, relay_session: dict, exchange_output: dict) -> ExecutionRelayBinding:
    binding = exchange_output["execution_exchange_binding"]
    return ExecutionRelayBinding(
