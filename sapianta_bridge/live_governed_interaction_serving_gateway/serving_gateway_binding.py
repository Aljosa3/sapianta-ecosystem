"""Serving gateway continuity binding."""
...
def create_serving_gateway_binding(*, gateway_session: dict, terminal_output: dict) -> ServingGatewayBinding:
    binding = terminal_output["terminal_attachment_binding"]
    return ServingGatewayBinding(
