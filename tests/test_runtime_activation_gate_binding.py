from sapianta_bridge.governed_runtime_activation_gate.runtime_activation_gate_binding import create_runtime_activation_gate_binding


def test_runtime_activation_gate_binding_preserves_bridge_lineage():
    binding = create_runtime_activation_gate_binding(
        gate_session={"runtime_activation_gate_id": "ACT-1", "activation_authorized": True, "approved_by": "human"},
        bridge_output={
            "local_runtime_bridge_binding": {
    ...
    assert binding["local_runtime_bridge_session_id"] == "BR-1"
