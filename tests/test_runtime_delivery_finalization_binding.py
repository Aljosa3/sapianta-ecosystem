from sapianta_bridge.governed_runtime_delivery_finalization.runtime_delivery_finalization_binding import create_runtime_delivery_finalization_binding


def test_runtime_delivery_finalization_binding_preserves_commit_lineage():
    binding = create_runtime_delivery_finalization_binding(
        finalization_session={"runtime_delivery_finalization_id": "FIN-1"},
        commit_output={
            "runtime_execution_commit_binding": {
    ...
    assert binding["runtime_execution_commit_id"] == "COMMIT-1"
    assert binding["runtime_delivery_finalization_id"] == "FIN-1"
