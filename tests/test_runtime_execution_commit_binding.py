from sapianta_bridge.governed_runtime_execution_commit.runtime_execution_commit_binding import create_runtime_execution_commit_binding


def test_runtime_execution_commit_binding_preserves_activation_lineage():
    binding = create_runtime_execution_commit_binding(
        commit_session={"runtime_execution_commit_id": "COMMIT-1"},
        activation_output={
    ...
    assert binding["runtime_activation_gate_id"] == "ACT-1"
