from sapianta_bridge.governed_execution_exchange.execution_exchange_validator import validate_execution_exchange


def test_execution_exchange_validator_blocks_missing_result_capture():
    result = validate_execution_exchange(
        ...
        ingestion_output={"validation": {"valid": True}, "live_request_ingestion_binding": {"live_request_ingestion_session_id": "INGEST-1"}},
    )
