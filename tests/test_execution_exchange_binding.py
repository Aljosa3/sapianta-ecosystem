from sapianta_bridge.governed_execution_exchange.execution_exchange_binding import create_execution_exchange_binding


def test_execution_exchange_binding_preserves_exchange_lineage():
    binding = create_execution_exchange_binding(
        exchange_session={"execution_exchange_session_id": "EX-1"},
        ingestion_output={
            "live_request_ingestion_binding": {
